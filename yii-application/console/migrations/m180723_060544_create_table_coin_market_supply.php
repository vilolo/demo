...
class m180723_060544_create_table_coin_market_supply extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%coin_market_supply}}', [
            ...
            'user_id' => $this->bigInteger()->defaultValue('0')->comment('供应方用户ID'),
            'nick_name' => $this->string()->defaultValue('')->comment('昵称'),
            'user_assets_id' => $this->bigInteger()->defaultValue('0')->comment('供应方用户资产ID'),
            'coin_id' => $this->bigInteger()->defaultValue('0')->comment('币ID'),
            'coin_code' => $this->string()->defaultValue('')->comment('币缩写'),
            'coin_quantity' => $this->decimal()->defaultValue('0.000000')->comment('供应总数量'),
            ...
            'min_quotas' => $this->decimal()->defaultValue('0.00')->comment('需求方最低购买额度（换算法币）'),
            'max_quotas' => $this->decimal()->defaultValue('0.00')->comment('需求方最高购买额度（换算法币）'),
    ...
    {
        $this->dropTable('{{%coin_market_supply}}');
    }
}
