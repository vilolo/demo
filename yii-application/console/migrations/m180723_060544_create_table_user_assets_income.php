...
class m180723_060544_create_table_user_assets_income extends Migration
{
    public function up()
    {
        $tableOptions = null;
        ...
        $this->createTable('{{%user_assets_income}}', [
            ...
            'coin_quantity' => $this->decimal()->defaultValue('0.000000')->comment('收入数量'),
    ...
    {
        $this->dropTable('{{%user_assets_income}}');
    }
}
